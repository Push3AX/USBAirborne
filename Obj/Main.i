...
#line 13 "Main.C" /0
 ...
 UINT8C  DBCAPACITY[] =       
 {
 ((UINT32)(2047999UL) >> 24) & 0xFF, ((UINT32)(2047999UL) >> 16) & 0xFF, ((UINT32)(2047999UL) >> 8) & 0xFF, (UINT32)(2047999UL) & 0xFF, ((UINT32)(4096UL) >> 24) & 0xFF, ((UINT32)(4096UL) >> 16) & 0xFF, ((UINT32)(4096UL) >> 8) & 0xFF, (UINT32)(4096UL) & 0xFF
 };
 ...
 {
 if((s[i]>='a')&&(s[i]<='z')){
 SendKey(0x00,s[i]-'a'+0x04);
 }else if((s[i]>='A')&&(s[i]<='Z')){
 SendKey(0x02,s[i]-'A'+0x04);
 }else if((s[i]>='1')&&(s[i]<='9')){
 SendKey(0x00,s[i]-'1'+0x1E);
 }else{
 switch(s[i]){
 case '0':
 SendKey(0x00,0x27);
